        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="venue" placeholder="Enter the venue of the event"  value="{{$event->venue}}" class="form-control" require>
                </div>
            </div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" name="event_date" class="form-control"  value="{{$event->event_date}}" data-auto-apply="true" require>
            </div>
          </div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="time" name="event_time" class="form-control"  value="{{$event->event_time}}" require>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6" style="display:none;" id="end-date">
                <div class="form-group">
                    ...
                    <input type="date" name="event_end_date" value="{{$event->event_end_date}}" class="form-control"  value="$event->event_end_date" data-auto-apply="true">
                </div>
            </div>
